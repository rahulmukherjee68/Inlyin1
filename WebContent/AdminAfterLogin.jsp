...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="AdminAfterLogin.jsp"><font size="5">ADMIN HOME</font></a></li>
...
<h2 align="center"><font color="Bisque">WELCOME ADMIN</font></h2>
<center><img alt="" src="globsyn images/adminhome.png"></center>
</body>
</html>