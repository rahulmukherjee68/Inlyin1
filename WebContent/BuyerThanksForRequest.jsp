...
<h3 align="center" ><font color="BISQUE">THANK YOU FOR APPLYING FOR THE PROPERTY ID :-<%out.print(request.getAttribute("PROPERTYID")); %> CHECK YOUR PROPERTY STATUS TO GET THE UPDATES</font></h2>
