...
/**
 * Servlet implementation class AdminDeleteRequestProperty
 */
@WebServlet("/AdminDeleteRequestProperty")
public class AdminDeleteRequestProperty extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDeleteRequestProperty() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		List<PropertyDetails> userlist=dbobj.fetchAllRecordOfRequests();
		if(userlist.size()>0) {
