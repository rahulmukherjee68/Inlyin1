...
/**
 * Servlet implementation class BuyerSearchProperty
 */
@WebServlet("/BuyerSearchProperty")
public class BuyerSearchProperty extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuyerSearchProperty() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(userlist.size()>0) {
			...
			RequestDispatcher rd=request.getRequestDispatcher("BuyerSearchPropertyResult.jsp");
		...
		else
		{
			...
			RequestDispatcher rd = 
				    request.getRequestDispatcher("BuyerSearchProperty.jsp");
			rd.forward(request,response);
